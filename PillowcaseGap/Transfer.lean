/-
Certificate 4 (Proposition: gauge transfer, master form). The
gauge group is a named field of a `Theory` structure, not a bare
quantifier absent from the data: the independence claim (iii) is
about a datum the structure genuinely carries.
